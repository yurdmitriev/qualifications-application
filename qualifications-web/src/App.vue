...
<template>
  <header>
    <nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary border-bottom bg-light">
      <div :class="{ 'container-fluid px-md-4': $route.meta.dashboard, container: !$route.meta.dashboard }">
        <button class="navbar-toggler d-md-none collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#topMenu" aria-controls="sidebarMenu" aria-expanded="false"
                aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
        <LogoComponent class="me-auto me-md-0 ms-2 ms-md-0" />
        <div class="collapse navbar-collapse me-auto ms-md-3 order-last order-md-0" id="topMenu" v-if="!$route.meta.dashboard">
