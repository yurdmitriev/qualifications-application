      ...
      <nav id="topMenu" class="col-md-3 col-lg-2 d-md-block bg-body-tertiary sidebar collapse border-end">
        <div class="position-sticky pt-3 sidebar-sticky">
          <ul class="nav flex-column">
            <li class="nav-item">
              <RouterLink class="nav-link" to="/dashboard/content">
            ...
            <li class="nav-item">
              <RouterLink class="nav-link" to="/dashboard/colleges">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                     stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">
                ...
                Надати інформацію про успішність студентів
              </a>
            </li>
          </ul>
        </div>
      </nav>
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-2 py-md-4 flex-grow-1 d-flex flex-column">
        <RouterView>
        </RouterView>
      </main>
    </div>
