<template>
  <div class="border bg-light rounded-top">
    <div class="btn-toolbar p-2" role="toolbar" aria-label="Editor Toolbar">
      <div class="btn-group btn-group-sm me-2" role="group">
        <button class="btn btn-outline-dark" type="button" :class="{ 'active': editor.isActive('bold') }"
        ...
        <button class="btn btn-outline-dark" type="button" :class="{ 'active': editor.isActive('italic') }"
        ...
        <button class="btn btn-outline-dark" type="button" :class="{ 'active': editor.isActive('strike') }"
      ...
      <div class="btn-group btn-group-sm me-2" type="button">
        <button class="btn btn-outline-dark" :class="{ 'active': editor.isActive('bulletList') }"
        ...
        <button class="btn btn-outline-dark" type="button" :class="{ 'active': editor.isActive('orderedList') }"
